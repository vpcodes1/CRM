...
class DiscoveryService {
     ...
     */
    async multiSearch(searchTerms, maxResults = 100) {
        const allPairs = [];
     ...
     */
    async findTrending(searchQuery = 'auto', limit = 10, filters = {}) {
     ...
     */
    async findNew(searchQuery = 'auto', maxAgeHours = 24, limit = 10, filters = {}) {
     ...
     */
    async findGainers(searchQuery = 'auto', limit = 10, filters = {}) {
     ...
     */
    async findLosers(searchQuery = 'auto', limit = 10, filters = {}) {
     ...
     */
    formatDiscoveryResults(pairs, title) {
        if (pairs.length === 0) {
